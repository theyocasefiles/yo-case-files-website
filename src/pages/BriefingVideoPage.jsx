export default function BriefingVideoPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-0 py-0 md:px-4 md:py-6">
        <div className="w-full bg-black md:rounded-[2rem] md:border md:border-white/10 md:bg-[#111318] md:p-4">
